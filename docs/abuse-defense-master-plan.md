...
- [x] **E3 — Phase C minimal + ChallengeV2 Rung 1 with teeth — DONE
      ...
      - [x] **Policy kinds: country / asn — DONE 2026-09-20** (operator
        ...
        decision-cache window; with web-detector enrichment off
        (`ENRICH = 0`) an ASN policy never matches and a country
        `challenge_v2` acts as plain challenge (fail-open) — the node logs
        `[fppolicy] WARNING: web-detector enrichment is off …` with the
        counts, once per change (2026-09-22).
