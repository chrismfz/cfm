...
echo "    Mixed hostnames (server FQDN vs account domain): set CPANEL_PLUGIN_CANONICAL_HOST or API_URL host to server FQDN"
echo "      - Plugin auto-falls back to https://<canonical-host>:TLS_PORT when HTTP_HOST does not match canonical host"
