...
func init() {
	meta.Register(meta.DetectorMeta{
		...
		DefaultsTemplate:  map[string]string{"ENABLED": "1", "EVERY": "20s", "WINDOW": "15m", "COOLDOWN": "20m", "BLOCK": "dryrun"},
	...
	meta.Register(meta.DetectorMeta{
		...
		DefaultsTemplate:  map[string]string{"ENABLED": "1", "EVERY": "20s", "WINDOW": "15m", "BLOCK": "dryrun"},
		LeniencySupported: true,
	})
