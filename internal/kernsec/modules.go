...
var Tier1Modules = []ModuleRule{
	...
	{
		ID: "KSEC-MOD-net.legacy-002", Group: "modules.net.legacy", Tier: Tier1,
		Name: "sctp",
		Description: "Stream Control protocol; telco-only.",
		Affects:     "Breaks lksctp users (rare on hosting).",
	},
	{
