...
func (e *Engine) RegisterHTTP(mux *http.ServeMux) {
	...
	mux.HandleFunc("/api/v1/clam/exclude/list", e.handleClamExcludeList)
	mux.HandleFunc("/api/v1/clam/exclude/add", e.handleClamExcludeAdd)
	mux.HandleFunc("/api/v1/clam/exclude/remove", e.handleClamExcludeRemove)
