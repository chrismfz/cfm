...
# Site Cache — provision and heal the cache dirs BEFORE the deploy helper
...
# helper also makes the parent traversable by the cfm workers and heals a
# cache tree left in another group by an older run; it is the ONE copy of this
