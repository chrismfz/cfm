...
deb: build
	...
	@install -m0640 "$(CONFIG_DIR)/cfm.dnat_bypass" "$(PKGROOT)/etc/cfm/cfm.dnat_bypass"
	@install -m0640 "$(CONFIG_DIR)/cfm.dnat_cpanel_bypass" "$(PKGROOT)/etc/cfm/cfm.dnat_cpanel_bypass"
