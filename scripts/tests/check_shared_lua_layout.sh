...
manifest='cfm.lua cfm_panel.lua cfm_rules.lua cfm_stats.lua cfm_waf.lua cfm_waf_util.lua cfm_waf_detectors.lua cfm_clamav.lua cfm_cache_log.lua cfm_clearance.lua cfm_geo.lua log-cfm.lua sslcollector.lua'
